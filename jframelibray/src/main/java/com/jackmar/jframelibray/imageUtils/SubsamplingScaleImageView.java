...
package com.jackmar.jframelibray.imageUtils;
...
import com.jackmar.jframelibray.imageUtils.decoder.CompatDecoderFactory;
import com.jackmar.jframelibray.imageUtils.decoder.DecoderFactory;
import com.jackmar.jframelibray.imageUtils.decoder.ImageDecoder;
import com.jackmar.jframelibray.imageUtils.decoder.ImageRegionDecoder;
import com.jackmar.jframelibray.imageUtils.decoder.SkiaImageDecoder;
import com.jackmar.jframelibray.imageUtils.decoder.SkiaImageRegionDecoder;
...
public class SubsamplingScaleImageView extends View {
    ...
    private TilesInitTask mTilesInitTask;
    private BitmapLoadTask loadPreviewTask;
    ...
    public final void setImage(ImageSource imageSource, ImageSource previewSource, ImageViewState state) {
        ...
        if (previewSource != null) {
            ...
            if (previewSource.getBitmap() != null) {
                ...
                if (loadPreviewTask != null && !loadPreviewTask.isCancelled()) {
                    loadPreviewTask.cancel(true);
                }
                loadPreviewTask = new BitmapLoadTask(this, getContext(), bitmapDecoderFactory, uri, true);
                loadPreviewTask.execute();
            }
        }
        ...
        if (imageSource.getBitmap() != null && imageSource.getSRegion() != null) {
            ...
            //I can't understand why the image source will tile property?
            ////imageSource.getTile()  FIXME: 16-1-11 Whatever i modified there, i'm img browser is worked.
            if (imageSource.getTile() || this.sRegion != null) {
                // Load the bitmap using tile decoding.
                mTilesInitTask = new TilesInitTask(this, getContext(), regionDecoderFactory, uri);
                mTilesInitTask.execute();
            } else {
                // Load the bitmap as a single image.
                mBitmapLoadTask = new BitmapLoadTask(this, getContext(), bitmapDecoderFactory, uri, false);
    ...
    private void reset(boolean newImage) {
        ...
        if (newImage) {
            ...
            try {
                if (mTilesInitTask != null) {
                    mTilesInitTask.cancel(true);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            if (subsamplingScaleImageView != null && !isCancelled()) {
                if (bitmap != null && orientation != null) {
                    if (preview) {
                        ...
                        //// FIXME: 16-1-7
                        if (subsamplingScaleImageView.loadPreviewTask != null && !subsamplingScaleImageView.loadPreviewTask.isCancelled()) {
                            subsamplingScaleImageView.loadPreviewTask.cancel(true);
                        }
