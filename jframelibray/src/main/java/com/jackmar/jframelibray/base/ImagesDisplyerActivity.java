...
import com.jackmar.jframelibray.fileutils.FileUtils;
import com.jackmar.jframelibray.fileutils.StreamUtils;
import com.jackmar.jframelibray.utils.CommonUtils;
 ...
 */
public class ImagesDisplyerActivity extends JBaseAct implements View.OnClickListener, ViewPager.OnPageChangeListener {
                    ...
                    .setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            try {
                                ...
                                showToast(getString(isSuccessful ? R.string.save_successful : R.string.save_failure));
                            } catch (IOException e) {
                                e.printStackTrace();
            ...
            new AlertDialog.Builder(this).setTitle(R.string.alert).setMessage(R.string.img_alread_exists_you_want_to_overwite)
                    .setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            showToast(getString(R.string.downloading_please_wait_a_mount));
                        }
                    })
                    .setNegativeButton(R.string.cancel, null).show();
        } else {
