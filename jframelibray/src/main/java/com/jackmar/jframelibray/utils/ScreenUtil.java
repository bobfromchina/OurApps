...
public class ScreenUtil {
    ...
    public void init(Context context) {
        ...
        PreHelper.defaultCenter(context).setData(PreferenceKey.SCREEN_WIDTH, width);
        PreHelper.defaultCenter(context).setData(PreferenceKey.SCREEN_WIDTH, width);
    }
    ...
    public int getWidth() {
        if (width == 0) {
            width = PreHelper.defaultCenter(context).getIntData(PreferenceKey.SCREEN_WIDTH);
        }
        return width;
    }
    ...
    public int getHeight() {
        if (height == 0) {
            height = PreHelper.defaultCenter(context).getIntData(PreferenceKey.SCREEN_HEIGHT);
        }
        return height;
    }
