...
public class PreHelper {
    ...
    public static PreHelper defaultCenter(Context context) {
    ...
    public PreHelper(Context context) {
        preference = context.getApplicationContext().getSharedPreferences("SharedPreferences", Context.MODE_PRIVATE);
    }
    ...
    public HashSet<String> getStringSet(String key) {
        ...
        return (HashSet<String>) preference.getStringSet(key, new HashSet<String>());
    }
}
