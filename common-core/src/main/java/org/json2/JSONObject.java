...
// Note: this class was written without inspecting the non-free org.json2 sourcecode.
...
public class JSONObject {
    ...
    public static Object wrap(Object o) {
        ...
        try {
            ...
            for (Field f : fields) {
                ...
                if (CommonUtils.fieldCanBeModify(f)) {
                    jo.put(CommonUtils.generateUnderlineName(f.getName()), wrap(f.get(o)));
                }
            }
            return jo;
    ...
    public LinkedHashMap<String, Object> getNameValuePairs() {
