...
import static com.amap.loc.c.a;
...
public class SystemBarTintManager {
    ...
    private static boolean sIsMeiZu;
    ...
    static {
        ...
        sIsMiui = XIAOMI.equals(Build.BRAND);
        sIsMeiZu = MEIZU.equals(android.os.Build.BRAND);
            ...
            try {
                ...
                if (sIsMiui) {
                    try {
                        ...
                        if (TextUtils.isEmpty(sMiuiVersion)) sMiuiVersion = null;
                    } catch (Exception e) {
                        sMiuiVersion = null;
                    }
                }
