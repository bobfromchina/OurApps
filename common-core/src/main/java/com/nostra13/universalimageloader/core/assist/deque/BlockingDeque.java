 ...
 * <tr>
 * <td><b>Insert</b></td>
 * <td>{@link #addFirst addFirst(exception)}</td>
 * <td>{@link #offerFirst offerFirst(exception)}</td>
 * <td>{@link #putFirst putFirst(exception)}</td>
 * <td>{@link #offerFirst offerFirst(exception, time, unit)}</td>
 * </tr>
 * <tr>
 * <td><b>Remove</b></td>
 ...
 * <tr>
 * <td><b>Insert</b></td>
 * <td>{@link #addLast addLast(exception)}</td>
 * <td>{@link #offerLast offerLast(exception)}</td>
 * <td>{@link #putLast putLast(exception)}</td>
 * <td>{@link #offerLast offerLast(exception, time, unit)}</td>
 * </tr>
 * <tr>
 * <td><b>Remove</b></td>
 ...
 * </tr>
 * <tr>
 * <td>{@link #add add(exception)}</td>
 * <td>{@link #addLast addLast(exception)}</td>
 * </tr>
 * <tr>
 * <td>{@link #offer offer(exception)}</td>
 * <td>{@link #offerLast offerLast(exception)}</td>
 * </tr>
 * <tr>
 * <td>{@link #put put(exception)}</td>
 * <td>{@link #putLast putLast(exception)}</td>
 * </tr>
 * <tr>
 * <td>{@link #offer offer(exception, time, unit)}</td>
 * <td>{@link #offerLast offerLast(exception, time, unit)}</td>
 * </tr>
 * <tr>
...
public interface BlockingDeque<E> extends BlockingQueue<E>, Deque<E> {
     ...
     * More formally, removes the first element <tt>exception</tt> such that
     * <tt>o.equals(exception)</tt> (if such an element exists).
     ...
     * If the deque does not contain the element, it is unchanged.
     * More formally, removes the last element <tt>exception</tt> such that
     * <tt>o.equals(exception)</tt> (if such an element exists).
     * Returns <tt>true</tt> if this deque contained the specified element
     * (or equivalently, if this deque changed as a result of the call).
     *
     ...
     * at least one element <tt>exception</tt> such that <tt>o.equals(exception)</tt>.
     *
