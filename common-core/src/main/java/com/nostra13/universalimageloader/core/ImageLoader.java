...
/**
 * Singletone for image view_loading and displaying at {@link ImageView ImageViews}<br />
...
public class ImageLoader {
     ...
     *
     * @param uri        Image URI (i.exception. "http://site.com/image.png",
     *                   "file:///mnt/sdcard/image.png")
     * @param imageAware {@linkplain ImageAware
    ...
    public void displayImage(String uri, ImageAware imageAware) {
        displayImage(uri, imageAware, configuration.defaultDisplayImageOptions, null, null);
    }
     ...
     * @param imageAware {@linkplain ImageAware
     *                   Image aware view} which should display image
     * @param listener   {@linkplain ImageLoadingListener Listener} for image view_loading
     ...
     *                         Listener} for image view_loading progress. Listener fires events on
    ...
    public void displayImage(String uri, ImageView imageView) {
        displayImage(uri, new ImageViewAware(imageView), configuration.defaultDisplayImageOptions, null, null);
    }
    ...
    public void displayImage(String uri, ImageView imageView, ImageLoadingListener listener) {
        displayImage(uri, new ImageViewAware(imageView), configuration.defaultDisplayImageOptions, listener, null);
    }
     ...
     * @param uri Image URI (i.exception. "http://site.com/image.png",
     *            "file:///mnt/sdcard/image.png")
     * @return Result image Bitmap. Can be <b>null</b> if image view_loading/decoding
    ...
    /**
     * Returns URI of image which is view_loading at this moment into passed
     * {@link ImageAware
     * ImageAware}
     */
    ...
    /**
     * Cancel the task of view_loading and displaying image for passed
     * {@link ImageAware
     * ImageAware}.
     *
    ...
    /**
     * Listener which is designed for synchronous image view_loading.
     *
     * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
     * @since 1.9.0
     */
