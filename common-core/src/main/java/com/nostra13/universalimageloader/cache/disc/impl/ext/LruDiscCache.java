...
public class LruDiscCache implements DiskCache {
     ...
     * @throws IOException if cache can't be initialized (exception.g. "No space left on device")
     */
    ...
    private void initCache(File cacheDir, File reserveCacheDir, long cacheMaxSize, int cacheMaxFileCount)
        ...
        try {
            ...
            if (cache == null) {
                throw e; //new RuntimeException("Can't initialize disk cache", exception);
            }
        }
    }
