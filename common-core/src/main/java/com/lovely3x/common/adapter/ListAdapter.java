...
public abstract class ListAdapter<T> extends BaseAdapter {
     ...
     * 显示选项
     */
    protected final ImageDisplayOptions options = CommonApplication.getInstance()
            .getImageLoaderDisplayOptionsBuilder().build();

    /**
     * 正方形显示选项
     */
    protected final ImageDisplayOptions mSquareOptions = options;

    /**
     * 长方形显示选项
     */
    protected final ImageDisplayOptions mRectangleOptions = CommonApplication.getInstance()
            .getRectangleImageLoaderDisplayOptionsBuilder().build();
