 ...
 * <p>You should never use a ScrollView with a {@link android.widget.ListView}, because
 ...
 * use {@link android.widget.HorizontalScrollView}.
 *
...
//    private StrictMode.Span mFlingStrictSpan = null;
    ...
    public ScrollView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private boolean canScroll() {
        ...
        if (child != null) {
            ...
            return getHeight() < childHeight + getPaddingTop() + getBottom();
        }
        return false;
    }
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_MOVE: {
                ...
                */
                ...
                if (yDiff > mTouchSlop
                        && (
                        (Build.VERSION.SDK_INT >= LOLLIPOP && (getNestedScrollAxes() & SCROLL_AXIS_VERTICAL) == 0)
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    if (overScrollBy(0, deltaY, 0, getScrollY(), 0, range, 0, mOverscrollDistance, true)
                            &&
                            (Build.VERSION.SDK_INT >= VERSION_CODES.LOLLIPOP && !hasNestedScrollingParent())
                    ...
                    if (Build.VERSION.SDK_INT >= VERSION_CODES.LOLLIPOP && dispatchNestedScroll(0, scrolledDeltaY, 0, unconsumedY, mScrollOffset)) {
...
//            invalidateParentIfNeeded();
    ...
    protected void measureChild(View child, int parentWidthMeasureSpec,
        ...
        childHeightMeasureSpec = makeSafeMeasureSpec(
                MeasureSpec.getSize(parentHeightMeasureSpec), UNSPECIFIED);
    ...
    /**
     * Like {@link android.view.View.MeasureSpec#makeMeasureSpec(int, int)}, but any spec with a mode of UNSPECIFIED
...
//            }
    ...
    private void flingWithNestedDispatch(int velocityY) {
        ...
        if ((Build.VERSION.SDK_INT >= LOLLIPOP && !dispatchNestedPreFling(0, velocityY))
                || Build.VERSION.SDK_INT < VERSION_CODES.LOLLIPOP) {
