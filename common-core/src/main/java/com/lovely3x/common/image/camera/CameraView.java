...
public class CameraView implements SurfaceHolder.Callback, Camera.PictureCallback,
                ...
                public void run() {
                    ...
                    try {
                        ...
                        try {
                            ...
                            ALog.d(TAG, "take photo orientation -> " + takePhotoOrientation);
    ...
    public void onShake(int orientation) {
        ...
        ALog.d(TAG, "onShake->" + orientation);
    }

    public interface OnCameraSelectListener {
        void onTakePicture(boolean success, String filePath);

        void onChangeFlashMode(int flashMode);

        void onChangeCameraPosition(int camera_position);
