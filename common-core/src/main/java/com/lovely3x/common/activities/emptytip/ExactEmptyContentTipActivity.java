...
public abstract class ExactEmptyContentTipActivity extends AbstractEmptyContentTipActivity {
    ...
    public void handleEmptyContent(View.OnClickListener listener) {
        ...
        transitionView = getLayoutInflater().inflate(com.lovely3x.common.R.layout.view_empty_data, emptyContainer, false);
    ...
    public void handleLoadingContent() {
        ...
        transitionView = getLayoutInflater().inflate(com.lovely3x.common.R.layout.view_loading, emptyContainer, false);
        emptyContainer.addView(transitionView);
    }
    ...
    public void handleLoadFailure(String errorMsg, View.OnClickListener retryListener) {
        ...
        //将现在的过渡视图添加进去
        transitionView = getLayoutInflater().inflate(com.lovely3x.common.R.layout.view_load_failure, emptyContainer, false);
        emptyContainer.addView(transitionView);
        //设置点击监听器
