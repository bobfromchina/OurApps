...
public class StickyListHeadersListView extends FrameLayout {
    ...
    /**
     */
    private boolean enablePushEffect;
    ...
    public interface OnStickyHeaderOffsetChangedListener {
         ...
         * @param header The currently sticky header being offset. This header is
         ...
         * @param offset The amount the sticky header is offset by towards to top
         *               of the screen.
         */
    ...
    public StickyListHeadersListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                // -- ListView attributes --
                mList.setFadingEdgeLength(a.getDimensionPixelSize(R.styleable.StickyListHeadersListView_android_fadingEdgeLength, mList.getVerticalFadingEdgeLength()));
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                    mList.setFastScrollAlwaysVisible(a.getBoolean(R.styleable.StickyListHeadersListView_android_fastScrollAlwaysVisible, mList.isFastScrollAlwaysVisible()));
                }
                ...
                mList.setTranscriptMode(a.getInt(R.styleable.StickyListHeadersListView_android_transcriptMode, ListView.TRANSCRIPT_MODE_DISABLED));
    ...
    private void updateOrClearHeader(int firstVisiblePosition) {
        ...
        final boolean isFirstViewBelowTop = doesListHaveChildren && mList.getFirstVisiblePosition() == 0 && mList.getChildAt(0).getTop() >= stickyHeaderTop();
